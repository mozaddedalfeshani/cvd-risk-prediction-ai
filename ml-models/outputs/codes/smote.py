...
print("=" * 65)
try:
    prev = pd.read_csv("outputs/accuracy/binary_results.csv")
...
bin_res.to_csv("outputs/accuracy/smote_binary_results.csv", index=False)
multi_res.to_csv("outputs/accuracy/smote_multi_results.csv", index=False)
