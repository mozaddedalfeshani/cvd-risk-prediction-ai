...
if __name__ == '__main__':
    ...
    print(f"Health check: http://54.160.253.120:5001/api/health")
    print(f"Features: http://54.160.253.120:5001/api/features")
    print(f"Example data: http://54.160.253.120:5001/api/example?type=low_risk")
